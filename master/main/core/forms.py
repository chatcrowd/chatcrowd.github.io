...
class LoginForm(FlaskForm):
    workerid = StringField('workerid', id='workerid', validators=[Required()], default='user789')
    username = StringField('username', id="username", validators=[Required()], default='Alice')
    ...
    task_id = StringField('task_id', id="task_id", validators=[Required()], default="12348")
    tasks = StringField('tasks', id="tasks", validators=None, default="12348")
